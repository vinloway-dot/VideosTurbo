...
EXPECTED_CLOUD_AGENT_PATHS = {
    ...
    ("POST", "/api/v1/cloud-agent/videos/{job_id}/thumbnail-prompt"),
    ...
    ("GET", "/api/v1/cloud-agent/thumbnail-prompt/settings"),
    ("PUT", "/api/v1/cloud-agent/thumbnail-prompt/settings"),
    ("GET", "/api/v1/cloud-agent/thumbnail-prompt/providers"),
    ("PUT", "/api/v1/cloud-agent/thumbnail-prompt/providers/{provider_id}/api-key"),
    ("DELETE", "/api/v1/cloud-agent/thumbnail-prompt/providers/{provider_id}/api-key"),
